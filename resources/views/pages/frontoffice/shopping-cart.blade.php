                ...
                <div class="flex flex-col sm:flex-row justify-between items-center sm:items-start mx-4">
                    ...
                    <div class="flex items-end">
                        <button onclick="proceedToPayment()" type="button"
                            class=" rounded-md bg-d-green py-2.5 px-3.5 text-sm font-semibold text-white shadow-sm hover:bg-cyan-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                            onclick="postData()">
